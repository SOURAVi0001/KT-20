...
import "./scorecard.css"; // Make sure this file exists and is properly linked

const ScorecardPage = () => {
  const [data, setData] = useState(null);

  useEffect(() => {
    axios.get("https://core-prod-origin.cricclubs.com/core/scoreCard/getScoreCard", {
      params: { matchId: 238, clubId: 17793 },headers: {
  ...
  if (!data) {
    return <div className="text-center text-gray-600 mt-4">No scorecard data available.</div>;
  }
